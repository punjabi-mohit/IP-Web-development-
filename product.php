...
<?php
		...
		$query  = "SELECT * FROM product where name='OnePlus 7 (Mirror Grey, 6GB RAM, Optic AMOLED Display, 128GB Storage, 3700mAH Battery)'";
		$result = $conn->query($query);
...
<div class="card1">
    <div class="nav">
      <img Style="width:40px;height:40px;" onclick="change_img(this)" id="2" class="image-conatiner" src="img1.jpg"><br>
      <img Style="width:40px;height:40px;" onclick="change_img(this)" id="3" class="image-conatiner" src="img2.jpg"><br>
      <img Style="width:40px;height:40px;" onclick="change_img(this)" id="4" class="image-conatiner" src="img3.jpg"><br>
      <img Style="width:40px;height:40px;" onclick="change_img(this)" id="5" class="image-conatiner" src="img4.jpg"><br>
      <img Style="width:40px;height:40px;" onclick="change_img(this)" id="6" class="image-conatiner" src="img5.jpg"><br>
       <?php echo"<img Style='width:40px;height:40px;' onclick='change_img(this)' id='7' class='image-conatiner' src='$image'>";?>
      </div>
      <div class="top-section">
        <img id="1" class="image-conatiner" onclick="change_img(this)" src="img1.jpg">
    </div>
    <div class="content">
   <p>OnePlus 7 (Mirror Blue, 6GB RAM, 128GB Storage)</p>
   <p>by <a href="#">oneplus</a></p>
<!--   <div class="rating"
  ...
  <a style="text-decoration:none;" href="#"> 13,603 reviews</a> |<a style="text-decoration:none;" href="#">1000+ answered questions</a>
   <hr>
<div class="price">
  <table>
    <tr>
    <td>Price:</td>
    <td><font color="red">₹ 32,999.00 </font></td>
    <td><img style="height:40px;" src="download.jpg"></td>
    <td><b>FREE DELIVERY.</b></td>
  <td><a >Details</a></td>
    </tr>
      <tr >
        <td></td>
          <td colspan="2">Inclusicve of all taxes</td>
        </tr>
    </table>
    <p><b>EMI</b> starts at ₹1,553. No Cost EMI available <a>options</a></p>
    <table>
      <tr>
      <td><img style="width:50%"  src="replace.png"</td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      <td><img style="width:50%" src="delivery.png"</td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      <td><img style="width:50%;" src="1year.png"</td>
      </tr>
      <tr>
        <td><a>10 Days<br>Replacement</a></td>
        <td><a>Amazon<br>Delivered</a></td>
        <td><a>1 Year<br>Warranty</a></td>
        </tr>
      </table>
      <hr>
      <p><font color="green;">In Stock</font></p><br>
      <p><font color="green;">Arrives before Dusshera</font></p>
      <p>Sold by <a>Rocket Kommerce LLP </a>(4.7 out of 5 | 3,752 ratings) and<a> Fulfilled by Amazon.</a></p>
      <p><a>2 offers</a>from<font> ₹32,999.00</font></p>
      <ul >
          <li> Rear Camera - 48MP (Primary) + 5 MP (Tele-photo) | Front Camera - 16MP</li>
          <li>16.2814 centimeters (6.41-inch) multi-touch capacitive touchscreen with 2340 x 1080 pixels resolution</li>
          <li>Memory, Storage and SIM: 6GB RAM | 128GB internal memory | Dual SIM dual-standby (4G+4G)</li>
          <li>Android Oxygen operating system with 2.84GHz Snapdragon 855 octa core processor</li>
          <li>3700mAH lithium-ion battery, Capture beauty under the moon with our new-and-improved Nightscape mode</li>
          ...
          <li>Box also includes: Power Adapter, Type-C Cable (Support USB 2.0), Quick Start Guide, Welcome Letter, Safety Information and Warranty Card, Logo Sticker, Case, Screen Protector (pre-applied) and SIM Tray Ejector</li>
          <li>For any product related queries contact_us on: [011-4019-4547]</li>
      </ul>
</div>
   </div>
   <div  class="cart">
	...
	<form method=post action="product.php?id=<?php echo $user ?>">
       <input type="submit" src="Untitled7.png"  name="cart1" Style="margin-left: 10px;width:170px;height:30px;margin-top:1em;" value="add to cart">
       <br>
